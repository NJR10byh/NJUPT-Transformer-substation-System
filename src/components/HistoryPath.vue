        ...
        >
          ...
          >
            <ul class="info">
              ...
              <li>
                <button style="float:right;margin-top:5px;font-size:14px;width:100px;height:20px" @click="HistoryPath">
                  查看历史路径
                </button>
              </li>
            </ul>
...
export default {
  ...
  methods: {
    ...
    HistoryPath(){
        if(this.markers[0].showFlag==true){
          this.Path=this.Pathhistory.paths2;
        }
        else if(this.markers[1].showFlag==true){
          this.Path=this.Pathhistory.paths1;
        }
        else if(this.markers[2].showFlag==true){
          this.Path=this.Pathhistory.paths3;
        }
    },
