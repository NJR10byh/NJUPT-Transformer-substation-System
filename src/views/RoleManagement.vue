      ...
      <div class="header-search">
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          ...
          <el-form-item style="margin-left: 20px">
            <el-select v-model="formInline.model" placeholder="请选择角色类型" style="width: 150px">
        ...
        <div class="oper-btns">
          ...
          >新增角色</el-button>
          <el-button class="del-btn" icon="el-icon-delete">删除</el-button>
        </div>
      </div>
      <!-- table -->
      <el-table
      ...
      <el-dialog title="新增人员" class="addManDialog" :visible.sync="dialogFormVisible">
        <el-form :model="form" :rules="rules" ref="form">
          <el-form-item label="工号" prop="number" :label-width="formLabelWidth">
            <el-input v-model="form.number" placeholder="请输入" autocomplete="off"></el-input>
          </el-form-item>
          ...
          <el-form-item :label-width="formLabelWidth">
            <el-button class="sub-btn" type="primary" @click="submitForm('form')">确认提交</el-button>
          </el-form-item>
        </el-form>
      </el-dialog>
    </el-main>
